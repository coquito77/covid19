...
linkEstimates <- "https://www.cdc.gov/H1N1flu/" %>%
  read_html() %>%
  html_nodes("a") %>%
  html_attr("href") %>%
  .[grepl("estimates", .)] %>%
...
save(US_StCoronaVirus, data_Date, US_CoronaVirus,  file = "US_StCoronaVirus.Rdata")
...
for (i in seq_along(iliList)) {
  ...
  tableLocation <- grep("Average Weekly Percentage|Percentage of ILI Emergency", txt)
...
sum_US_CoronaVirus %>% 
  ...
  labs(title  = "2009 H1N1 cases vs Covid-19"
       ,caption = "Note: y-axis is in logarithmic scale
Sources: The New York Times, https://github.com/nytimes/covid-19-data accessed 2020-03-31 (Covid19);
       https://www.cdc.gov/H1N1flu (H1N1)")
...
sum_US_CoronaVirus %>% 
  ...
  labs(title  = "2009 H1N1 cases vs Covid-19"
       ,caption = "Sources: The New York Times, https://github.com/nytimes/covid-19-data accessed 2020-03-31 (Covid19);
       https://www.cdc.gov/H1N1flu (H1N1)")
...
sum_US_CoronaVirus %>% 
  ...
  geom_line(aes(x = dayCnt
            ...
            colour = "red") +
  scale_y_log10(label= scales::comma) +
  coord_cartesian(xlim = c(1, 100), ylim = c(1, 10000)) +
  labs(title  = "2009 H1N1 deaths vs Covid-19"
       ,caption = "Note: y-axis is in logarithmic scale
Sources: The New York Times, https://github.com/nytimes/covid-19-data accessed 2020-03-31 (Covid19);
       https://www.cdc.gov/H1N1flu (H1N1)")
...
sum_US_CoronaVirus %>% 
  ...
  geom_line(aes(x = dayCnt
            ...
            colour = "red") +
  scale_y_continuous(label= scales::comma) +
  coord_cartesian(xlim = c(1, 100), ylim = c(0, 10000)) +
  labs(title  = "2009 H1N1 deaths vs Covid-19"
       ,caption = "Sources: The New York Times, https://github.com/nytimes/covid-19-data accessed 2020-03-31 (Covid19);
       https://www.cdc.gov/H1N1flu (H1N1)")
...
sum_US_CoronaVirus %>% 
  ...
  geom_line(aes(x = dayCnt
            ...
            colour = "red") +
  scale_y_continuous(label= scales::comma) +
  coord_cartesian(xlim = c(1, 300), ylim = c(0, 50000)) +
  labs(title  = "2009 H1N1 deaths vs Covid-19"
       ,caption = "Sources: The New York Times, https://github.com/nytimes/covid-19-data accessed 2020-03-31 (Covid19);
       https://www.cdc.gov/H1N1flu (H1N1)")
...
sum_St <- int %>% 
  ...
  mutate(popHosp = as.numeric(popHosp),
         ...
         popOverTotLicBed = popHosp/TOT_LIC_BEDS
         ,popOverTotLicIcBd = popHosp/IC_LIC_BEDS)
