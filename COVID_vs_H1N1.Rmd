...
countyTrends %>% 
  ...
  labs(title = "Days to double the number of cases"
       ,subtitle = "based on daily counts for when the counts increase from one day to the next day only, 
       the if the counts double in more than 35 days they show as 35 days."
       ,y = "Cases"
       ,x = ""
       ,caption = paste("Sources: The New York Times, https://github.com/nytimes/covid-19-data accessed"
                        ,data_Date
